...
const getUserDetails = async (req, res) => {
    ...
    return res.status(200).json({ username: user.username, email: user.email, assignedUsers: user.assignedUsers, todo: todo, backlog: backlog, inProgress: inProgress, done: done });
  } catch (error) {
